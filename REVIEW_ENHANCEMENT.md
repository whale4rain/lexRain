...
重构 Review 组件以展示 ECDICT 词典的完整元数据，采用左右分栏布局：**左侧显示释义（中文+英文），右侧显示词形变化**。
...
2. **英文释义**（中部）
   - 黄色标题："═══ English Definition ═══"
   - 每行释义独立显示，带缩进

3. **词频信息**（底部）
   - 深灰色 + 斜体
   - 格式："词频: BNC: 1234 | 当代: 5678"
...
**问题**：ECDICT 的 `pos` 字段格式为 `词性代码:权重`，如 `v:100`、`n:50/v:30`
...
| `n` | n. 名词 | Noun |
| `v` | v. 动词 | Verb |
| `j`, `a`, `adj` | adj. 形容词 | Adjective |
| `r`, `ad`, `adv` | adv. 副词 | Adverb |
| `prep` | prep. 介词 | Preposition |
| `c`, `conj` | conj. 连词 | Conjunction |
| `pron` | pron. 代词 | Pronoun |
| `i`, `int` | interj. 感叹词 | Interjection |
| `art` | art. 冠词 | Article |
| `num` | num. 数词 | Numeral |
| `aux` | aux. 助动词 | Auxiliary |
